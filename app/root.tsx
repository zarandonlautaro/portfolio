    ...
    return (
        <div className="layout">
            <header className="layout__header">
                <div className="container layout__header-content">
                    <Link
                        to="/"
                        title="Remix"
                        className="layout__header-home-link"
                    >
                        <img
                            src="https://avatars.githubusercontent.com/u/47615129?v=4"
            ...
            <div className="layout__main">
                <div className="container layout__main-content">{children}</div>
            </div>
            <footer className="layout__footer">
                <div className="container layout__footer-content">
                    <p>
                        &copy; Crafted by{" "}
                        <a href={"https://github.com/zarandonlautaro"}>
                            Lautaro Zarandón
                        </a>
                    </p>
                </div>
